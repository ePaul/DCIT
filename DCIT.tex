...
\abstract{Do we need an abstract for something so short?  I say no.  \\  Discourse connectives are bla bla. DCIT is a tool written in Python that analyzes the usage of discourse connectives amongst German Twitter data.  Bla bla}
...
\bibitem{dimlex}Manfred Stede. (2002). DiMLex: A lexical approach to discourse markers. In: A. Lenci, V. Di Tomaso (eds.): \emph{Exploring the Lexicon - Theory and Computation}. Alessandria (Italy): Edizioni dell'Orso, 2002.
